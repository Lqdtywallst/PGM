# Backlog Evolucion Del Sitio

## Objetivo

Traducir la arquitectura objetivo del sitio en un backlog corto, ejecutable y ordenado para empezar la evolucion hacia una web mas profesional sin perder traccion SEO.

## Regla Base

- No eliminar URLs publicas utiles mientras esta fase este en marcha.
- Toda fusion futura de landings debe pasar por redireccion `301`.
...
### 1. Reforzar la home como centro del sitio

- clarificar propuesta de valor principal
- hacer que la home se sienta mas marca y menos mezcla de bloques SEO
- mejorar jerarquia entre hero, fleet, delivery, reviews, about y contact
- preparar la home para enlazar a paginas troncales reales

### 2. Definir navegacion troncal

- decidir estructura final de menu:
  - Home
  - Fleet
  - Locations
  - Services
  ...
  - Contact
  - Reserve
- revisar que el menu no dependa de landings SEO para explicar la marca

## Fase 2. Paginas Troncales

### 3. Crear o separar Fleet

- reunir la flota en una pagina principal o una seccion mucho mas fuerte
- ordenar modelos por marca y tipo
- mantener CTA claros hacia reserva y WhatsApp

### 4. Crear o separar Locations

- convertir Palm Jumeirah, Dubai Marina, Downtown y Airport en una estructura limpia
- usar la pagina madre para enlazar a landings de zona y reducir dispersion

### 5. Crear o separar Services
...
### 6. Reforzar About y Contact

- subir credibilidad de marca
- explicar proceso real de trabajo
- limpiar y profesionalizar puntos de contacto

## Fase 3. Reescritura De Landings Clave
...
## Fase 5. SEO De Proteccion Durante La Evolucion
...
1. reforzar la home como pagina de marca
2. definir Fleet, Locations y Services como estructura principal
3. reescribir las 5 landings de prioridad alta
4. revisar solapes antes de fusionar nada
