...
const VIEWPORT_COVERAGE_MATRIX = Object.freeze([
  Object.freeze({
    ...
    hasTouch: true,
    deviceScaleFactor: 2,
    coverage: Object.freeze(['responsive', 'firstViewport', 'visualAgent', 'mobile', 'shortHeight']),
    intent: 'Tiny legacy phone viewport that guards against layouts tuned only for modern wide phones.',
  }),
  Object.freeze({
    name: 'mobile-short',
    tier: 'mobile',
...
const DESIGN_SYSTEM_CONTRACT = Object.freeze({
    ...
    fleet_filter_sheet: Object.freeze({
      tiers: Object.freeze({
        mobile: Object.freeze({
          ...
          minCompactScheduleControlWidthPx: 128,
          maxTextClipPx: 2,
          maxViewportClipPx: 2,
          ...
          minFieldLabelControlGapPx: 6,
          minModuleHeadingControlGapPx: 8,
          minTopbarToFirstModuleGapPx: 10,
          forbidPinnedClosedToolbar: true,
          requireDateTimeDisplaySync: true,
          requiredFilledValues: Object.freeze(['10:00', '18:00']),
    ...
    reserve_booking_intent: Object.freeze({
      tiers: Object.freeze({
        mobile: Object.freeze({
          ...
          minTapTargetPx: 44,
          minUsefulControlWidthPx: 220,
          minUsefulControlWidthRatio: 0.65,
          minCompactScheduleControlWidthPx: 112,
          maxHorizontalOverflowPx: 4,
          maxViewportClipPx: 2,
          maxTextClipPx: 2,
    ...
    mobile_card_actions: Object.freeze({
      tiers: Object.freeze({
        mobile: Object.freeze({
          ...
          minStackedContactButtonWidthRatio: 0.78,
          maxSecondaryButtonWidthRatio: 1.02,
          maxSecondaryDominanceRatio: 1.15,
          minSplitContactGroupWidthRatio: 0.985,
          maxSplitContactSideGapPx: 2,
          maxSplitContactOverflowPx: 2,
          minSplitContactStripHeightRatio: 0.065,
          requireStackedContactActions: false,
        ...
        laptop: Object.freeze({
          policy: 'locked',
          maxActionGroupHeightRatio: 0.28,
          maxSecondaryActionHeightRatio: 0.16,
          minStackedContactButtonWidthRatio: 0.62,
          maxSecondaryButtonWidthRatio: 1.02,
          maxSecondaryDominanceRatio: 1.05,
          minSplitContactGroupWidthRatio: 0.985,
          maxSplitContactGroupWidthRatio: 1.02,
          minSplitContactSideGapPx: 0,
          maxSplitContactSideGapPx: 2,
          maxSplitContactOverflowPx: 2,
          minSplitContactStripHeightRatio: 0.045,
          requireStackedContactActions: false,
          requireSingleRowContactSplit: true,
          allowFullBleedContactStrip: true,
          minFullBleedContactButtonWidthRatio: 0.42,
          maxFullBleedContactButtonWidthRatio: 0.58,
          maxFullBleedContactStripBottomGapPx: 18,
          minCardInlinePaddingPx: 10,
          minPrimaryActionHeightPx: 40,
          maxPrimaryActionHeightPx: 58,
          maxSecondaryActionHeightPx: 58,
          maxSecondaryContactActions: 2,
          maxButtonRadiusPx: 999,
          maxButtonRadiusSpreadPx: 999,
        }),
        desktop: Object.freeze({
          policy: 'locked',
          maxActionGroupHeightRatio: 0.26,
          maxSecondaryActionHeightRatio: 0.15,
          minStackedContactButtonWidthRatio: 0.58,
          maxSecondaryButtonWidthRatio: 1.02,
          maxSecondaryDominanceRatio: 1,
          minSplitContactGroupWidthRatio: 0.985,
          maxSplitContactGroupWidthRatio: 1.02,
          minSplitContactSideGapPx: 0,
          maxSplitContactSideGapPx: 2,
          maxSplitContactOverflowPx: 2,
          minSplitContactStripHeightRatio: 0.04,
          requireStackedContactActions: false,
          requireSingleRowContactSplit: true,
          allowFullBleedContactStrip: true,
          minFullBleedContactButtonWidthRatio: 0.42,
  ...
  firstViewportPolicies: Object.freeze({
    home: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          ...
          headingBalance: Object.freeze({
            requireCenteredText: true,
            maxViewportWidthPx: 760,
            maxLineCount: 3,
    ...
    hub_marketing: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          ...
          maxHeadingTopRatio: 0.62,
          maxPrimaryCtaTopRatio: 0.96,
          minPrimaryCtaWidthRatio: 0.34,
        }),
      }),
    }),
    ...
    brand_landing: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          policy: 'locked',
          check: 'mobile_useful_first_viewport',
          maxHeadingTopRatio: 0.58,
          maxPrimaryCtaTopRatio: 0.78,
          minPrimaryCtaWidthRatio: 0.34,
          usefulRectKey: 'vehicleBookingRect',
          usefulLabel: 'booking panel',
          maxUsefulTopRatio: 0.84,
        }),
      }),
    }),
    vehicle_pdp: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          policy: 'locked',
          check: 'mobile_useful_first_viewport',
          maxHeadingTopRatio: 0.68,
          maxPrimaryCtaTopRatio: 0.95,
          minPrimaryCtaWidthRatio: 0.34,
          usefulRectKey: 'vehicleBookingRect',
          usefulLabel: 'booking panel',
          maxUsefulTopRatio: 0.72,
        }),
      }),
    }),
    fleet: Object.freeze({
    ...
    reserve: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          policy: 'locked',
          check: 'reserve_mobile_schedule_reveal',
          maxIntroBottomRatio: 0.33,
          maxStepPillsBottomRatio: 0.43,
          maxStartDateTopRatio: 0.84,
          maxDeliveryCardTopRatio: 1.08,
          maxPickupLocationTopRatio: 1.22,
          shortViewportHeightPx: 680,
          shortMaxDeliveryCardTopRatio: 1.36,
          shortMaxPickupLocationTopRatio: 1.55,
        }),
      }),
    }),
    contact: Object.freeze({
      tiers: Object.freeze({
        ...
        mobile: Object.freeze({
          policy: 'locked',
          check: 'mobile_useful_first_viewport',
          maxHeadingTopRatio: 0.46,
          maxPrimaryCtaTopRatio: 0.72,
          minPrimaryCtaWidthRatio: 0.34,
          primaryCtaRectKey: 'contactHeroActionRect',
          usefulRectKey: 'contactFormCardRect',
          usefulLabel: 'contact form',
          maxUsefulTopRatio: 0.78,
        }),
      }),
    }),
  }),
      ...
      firstViewport: Object.freeze({
        tiers: Object.freeze({
          mobile: Object.freeze({
            policy: 'locked',
            check: 'mobile_useful_first_viewport',
            maxHeadingTopRatio: 0.42,
            maxPrimaryCtaTopRatio: 0.9,
            minPrimaryCtaWidthRatio: 0.72,
          }),
        }),
      }),
    }),
      ...
      firstViewport: Object.freeze({
        tiers: Object.freeze({
          laptop: Object.freeze({
            ...
            selectorBottomRatio: Object.freeze({ max: 0.98 }),
            minSelectorWidthRatio: 0.56,
            minOrbSlotFillRatio: 0.5,
            minOrbMediaWidthPx: 92,
            maxHeadingTopRatio: 0.64,
            maxHeadingBottomRatio: 0.72,
            requireNoFeaturePanel: true,
          }),
          desktop: Object.freeze({
            policy: 'locked',
            check: 'services_direct_lanes',
            ...
            minOrbSlotFillRatio: 0.54,
            minOrbMediaWidthPx: 120,
            maxHeadingTopRatio: 0.66,
            maxHeadingBottomRatio: 0.74,
            requireNoFeaturePanel: true,
          }),
          mobile: Object.freeze({
            policy: 'locked',
            ...
            maxHeadingBottomRatio: 0.42,
            minSelectorWidthRatio: 0.78,
            requireNoFeaturePanel: true,
          }),
        }),
      }),
      sectionRhythm: Object.freeze({
        tiers: Object.freeze({
          ...
          mobile: Object.freeze({
            policy: 'locked',
            check: 'mobile_useful_first_viewport',
            maxHeadingTopRatio: 0.54,
            maxPrimaryCtaTopRatio: 0.86,
            minPrimaryCtaWidthRatio: 0.34,
  ...
  cohorts: Object.freeze({
    home: Object.freeze({
      ...
      headerPrimaryNavSignatures: HEADER_NAV_SIGNATURES,
    ...
    brand_landing: Object.freeze({
      headingFontFamilies: Object.freeze(['el messiri']),
      bodyFontFamilies: Object.freeze(['manrope']),
      visualIntents: Object.freeze(['modern_light_system']),
      headerVariants: Object.freeze(['lab_mega_utility']),
      headerBrandFontFamilies: Object.freeze(['manrope']),
