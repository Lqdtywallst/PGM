...
async function openReserve(page) {
    await page.goto(
        '/app/reserve/page.html?car=Mercedes%20G63%20AMG&price=1650&startDate=2026-08-20&endDate=2026-08-22&pickupTime=10:00&dropoffTime=18:00',
...
test.describe('Mobile customer journeys', () => {
    ...
    test('home overlay passes schedule into fleet on mobile', async ({ page }) => {
        ...
        await page.locator('#hero-lab-pickup-date').fill('2026-09-03');
        await page.locator('#hero-lab-return-date').fill('2026-09-05');
